...
class SKBlock(nn.Module):
    def __init__(self, inchannel, outchannel, stride=1, groups=16):
        ...
        self.kernel2 = ResNextBlock(inchannel=inchannel, outchannel=outchannel, kernel_size=5, stride=stride, groups=groups)
        self.kernel3 = ResNextBlock(inchannel=inchannel, outchannel=outchannel, kernel_size=7, stride=stride, groups=groups)
        self.kernel4 = ResNextBlock(inchannel=inchannel, outchannel=outchannel, kernel_size=9, stride=stride, groups=groups)
