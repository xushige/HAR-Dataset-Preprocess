...
print(X_train.shape, X_test.shape, Y_train_onehot.shape, Y_test_onehot.shape, Y_train)

# np.save('data_npy/X_train.npy', X_train)
# np.save('data_npy/X_test.npy', X_test)
# np.save('data_npy/Y_train.npy', Y_train)
# np.save('data_npy/Y_test.npy', Y_test)
# np.save('data_npy/Y_train_onehot.npy', Y_train_onehot)
# np.save('data_npy/Y_test_onehot.npy', Y_test_onehot)